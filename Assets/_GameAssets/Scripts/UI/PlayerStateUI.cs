...
public class PlayerStateUI : MonoBehaviour
{
    ...
    [SerializeField] private Sprite _playerSlidingAactiveSprite;
    ...
    {
        SetStatesUserInterfaces(_playerWalkingActiveSprite, _playerSlidingPassiveSprite, _playerWalkingTransform, _playerSlidingTransform);
    }
    ...
    private void PlayerController_OnPlayerStateChanged(PlayerState playerState)
    {
        switch (playerState)
        {
            ...
            case PlayerState.Slide:
                SetStatesUserInterfaces(_playerWalkingPassiveSprite, _playerSlidingAactiveSprite, _playerSlidingTransform, _playerWalkingTransform);
                break;
        }
    }
