...
public class EggCounterUI : MonoBehaviour
{
    ...
    public void SetEggCompleted()
    {
        ...
        _eggCounterRectTransform.DOScale(1.5f, _scaleDuration).SetEase(Ease.OutBack).OnComplete(() =>
        {
            _eggCounterRectTransform.DOScale(1.2F, _scaleDuration).SetEase(Ease.InBack);
        });
    }
