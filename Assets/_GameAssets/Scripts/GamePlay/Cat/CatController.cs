...
public class CatController : MonoBehaviour
{
    ...
    [Header("Settings")]
    [SerializeField] private float _defualtSpeed = 5f;
    ...
    [SerializeField] private float _chaseDistanceThreshHold = 1.5f;
    ...
    private CatStatesController _catStateController;
    ...
    private void Awake()
    {
        ...
        _catStateController = GetComponent<CatStatesController>();
    }

    private void Start()
    {
        _initialPosition = transform.position;
        SetRandomDestionation();
    }
    ...
    private void SetChaseMovement()
    {
        ...
        Vector3 offetPosition = _playerTransform.position - directionToPlayer * _chaseDistanceThreshHold;
        _catAgent.SetDestination(offetPosition);
    ...
    private void SetRandomDestionation()
    {
        int attempts = 0;
        ...
        if (!destinationSet)
        {
            Debug.LogWarning("Faild to find a valid destination!");
            _isWaiting = true;
            _timer = _waitTime * 2;
        }
    }
